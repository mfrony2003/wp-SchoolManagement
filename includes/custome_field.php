...
{  /*<---START Lmgt_custome_field  CLASS--->*/
	...
	function mj_smgt_add_custom_field($custome_data) 
	{
		...
		{ 	
			...
			school_append_audit_log(''.esc_html__('Update Custom Field Detail','hospital_mgt').'',null,get_current_user_id(),'edit');
		...
		{ 
			school_append_audit_log(''.esc_html__('Add New Custom Field Detail','hospital_mgt').'',null,get_current_user_id(),'insert');
