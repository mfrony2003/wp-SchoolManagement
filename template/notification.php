                                    ...
                                    { 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php  if($strlength > 60){ echo substr($retrieved_data->message, 0,60).'...'; }else{ echo $retrieved_data->message; } ?> <i class="fa fa-info-circle fa_information_bg" data-toggle="tooltip" data-placement="top" title="<?php _e('Message','school-mgt');?>" ></i>
                                            </td>
                                            <?php
                                            if($user_access['edit']=='1' || $user_access['delete']=='1')
                                            {
