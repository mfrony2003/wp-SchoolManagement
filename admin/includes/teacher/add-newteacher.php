		...
		<div class="form-body user_form"> <!--user_form div-->  
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12 mt-3"><!--save btn--> 
					<input type="submit" id="class_for_alert" value="<?php if($edit){ esc_attr_e('Save Teacher','school-mgt'); }else{ esc_attr_e('Add Teacher','school-mgt');}?>" name="save_teacher" class="save_btn class_for_alert"/>
				</div><!--save btn--> 
			</div>
		</div>
	</form>
